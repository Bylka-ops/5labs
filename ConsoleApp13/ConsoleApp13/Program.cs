...
namespace ConsoleApp13
{
    ...
    {   People people;
        ...
        {
            this.year = Year;
            this.people = new People(FName, LName);
        }
        public void Print()
        {
            people.Print();
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            peoples.Add(new SpecialistsInSelectedSports("Константин", "Тишкевич", NameSports.Футбол.ToString(), "Игровые"));     
            ...
            peoples[2].Print();
            Console.WriteLine();
            Student student = new Student("Мяделец", "Валентин", 21);
            student.Print();
            Console.ReadKey();
        }
    }
